...
namespace LSL_PRO.Utilities
{
    ...
    public class DataTableHelper
    {
        ...
        /// <summary>
        /// 将两个列不同(结构不同)的DataTable合并成一个新的DataTable Add By mashanlin 2015-03-26
        /// </summary>
        ...
        public static DataTable UniteDataTable(DataTable dt1, DataTable dt2)
        {
            ...
            {
                if (!newDataTable.Columns.Contains(dt2.Columns[i].ColumnName))
            ...
            foreach (DataRow dr in dt2.Rows)
            {
                ...
                {
                    string name = dt2.Columns[j].ColumnName;
                    newDr[name] = dr[name];
                }
