...
namespace LSL_PRO.Utilities
{
    public class ImageClass
    {
        ...
        #region 缩略图
        /// <summary>
        /// 生成缩略图 Add By mashanlin 2014-11-20 扩展
        /// </summary>
        ...
        {
            using (Image originalImage = System.Drawing.Image.FromFile(originalImagePath))
            {
        ...
        /// 生成缩略图 Add By mashanlin 2014-11-20 扩展
        /// </summary>
        /// <param name="imageStream">源图</param>
        /// <param name="thumbnailPath">缩略图路径（物理路径）</param>
        /// <param name="width">缩略图宽度</param>
        /// <param name="height">缩略图高度</param>
        /// <param name="mode">生成缩略图的方式</param>    
        public static void MakeThumbnail(Stream imageStream, string thumbnailPath, int width, int height, string mode)
        {
            using (Image originalImage = System.Drawing.Image.FromStream(imageStream))
            {
                MakeThumbnail(originalImage, thumbnailPath, width, height, mode);
            }
        }
