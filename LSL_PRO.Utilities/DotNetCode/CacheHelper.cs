...
namespace LSL_PRO.Utilities
{
    ...
    public class CacheHelper
    {
        ...
        /// <param name="key">缓存Key</param>
        /// <param name="obj">object对象</param>
        /// <param name="expires">设置时间 单位：分钟</param>
        public static void Insert(string key, object obj, int expires)
        {
            if (obj != null)
            {
                 HttpContext.Current.Cache.Insert(key, obj, null, Cache.NoAbsoluteExpiration, new TimeSpan(0, expires, 0));
               //HttpContext.Current.Cache.Insert(key, obj, null, DateTime.MaxValue, new TimeSpan(0, expires, 0), System.Web.Caching.CacheItemPriority.NotRemovable, null);
            }
        }
        /// <summary>
        /// 判断缓存对象是否存在
