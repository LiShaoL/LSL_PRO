...
namespace LSL_PRO.Utilities
{
    ...
    public class ShowMsgHelper
    {
        ...
        {
            ExecuteScript(string.Format("showTipsMsg('{0}','3000','4');windowload();", message));
        }
        /// <summary>
        /// 默认成功提示，刷新父窗口函数关闭页面
        /// </summary>
        ...
        {
            ExecuteScript(string.Format("showTipsMsg('{0}','3000','4');top.$('#' + Current_iframeID())[0].contentWindow.windowload();OpenClose();", message));
        }
        /// <summary>
        /// 默认成功提示，刷新父窗口函数关闭页面
        /// </summary>
        ...
        {
            ExecuteScript(string.Format("showTipsMsg('{0}','3000','4');top.$('#' + Current_iframeID())[0].contentWindow.target_right.windowload();OpenClose();", message));
        }
        /// <summary>
        /// 默认错误提示
        /// </summary>
        ...
        /// </summary>
        /// <param name="message">显示消息</param>
        public static void Alert_Warn(string message)
        {
