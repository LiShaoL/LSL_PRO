...
namespace LSL_PRO_DAL
{
    public class UserDAL:UserIDAL
    {
        ...
        /// <param name="user"></param>
        /// <returns></returns>
        public int UpdateUser(LSL_PRO_User user)
        {
            return DBHelperFactory.DbUtils(ConfigHelper.GetValue("SqlServer_LSL")).Update(user, "Account");
        }
        ...
        {
            return DBHelperFactory.DbUtils(ConfigHelper.GetValue("SqlServer_LSL")).Delete("LSL_PRO_User", "UserId", id);
        }
    }
}
